...
3. If the work needs Mint assets, resolve one Mint Project for the local
...
4. Establish one owner for renderer, scene, camera, animation frame, resize,
   asset lifecycle, and disposal.
5. Use Mint MCP through `../../references/mint-mcp-assets.md` when production
...
9. Follow `../../references/verification-policy.md`: run the automatic minimum,
